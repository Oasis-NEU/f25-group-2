...
export default function TabTwoScreen() {
  ...
  const collapsibles = [
    { title: 'File-based routing', contentKey: 'fileRouting' },
    { title: 'Android, iOS, and web support', contentKey: 'platformSupport' },
    { title: 'Images', contentKey: 'images' },
    { title: 'Light and dark mode components', contentKey: 'themeSupport' },
    { title: 'Animations', contentKey: 'animations' },
  ];

  // Filter collapsibles based on search query
  const filteredCollapsibles = collapsibles.filter(c =>
  ...
  return (
    ...
    >
      ...
      {/* Render filtered collapsible sections */}
      {filteredCollapsibles.map(c => {
        switch (c.contentKey) {
          case 'fileRouting':
            return (
              <Collapsible key={c.contentKey} title={c.title}>
                <ThemedText>
          ...
          case 'platformSupport':
            return (
              <Collapsible key={c.contentKey} title={c.title}>
                <ThemedText>
                  You can open this project on apple, iOS, and the web. To open the web version, press{' '}
